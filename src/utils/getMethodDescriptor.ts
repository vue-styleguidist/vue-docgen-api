...
import { MethodDescriptor } from 'src/Documentation'
import { BlockTag } from './blockTags'
import getDocblock from './getDocblock'
import getDoclets, { DocBlockTags, Param, ParamTag, ParamType } from './getDoclets'
import transformTagsIntoObject from './transformTagsIntoObject'

export default function getMethodDescriptor(
  method: NodePath<bt.Property>,
